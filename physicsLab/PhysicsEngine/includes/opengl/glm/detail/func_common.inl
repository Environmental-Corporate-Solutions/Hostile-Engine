...
/*
	// roundEven
	template<typename genType>
	GLM_FUNC_QUALIFIER genType roundEven(genType const& a)
	{
		GLM_STATIC_ASSERT(std::numeric_limits<genType>::is_iec559, "'roundEven' only accept floating-point inputs");

		return genType(int(a + genType(int(a) % 2)));
	}
*/
	...
	GLM_FUNC_QUALIFIER genType roundEven(genType x)
	{
		...
		//{
		//	return mix(IntegerPart + genType(-1), IntegerPart + genType(1), a <= genType(0));
		//}
	}
...
#		endif
	...
	//// Only valid if (INT_MIN <= a-b <= INT_MAX)
	//// min(a,b)
	//r = b + ((a - b) & ((a - b) >> (sizeof(int) *
	//CHAR_BIT - 1)));
	//// max(a,b)
	//r = a - ((a - b) & ((a - b) >> (sizeof(int) *
	//CHAR_BIT - 1)));
