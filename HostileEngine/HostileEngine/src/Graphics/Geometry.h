...
namespace Hostile
{
    ...
    private:
        ...
        static constexpr std::array<D3D12_INPUT_ELEMENT_DESC, InputElementCount> InputElements =
        {
            ...
            D3D12_INPUT_ELEMENT_DESC{ "COLOR",       0, DXGI_FORMAT_R32_FLOAT,          0, D3D12_APPEND_ALIGNED_ELEMENT, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },
            ...
            D3D12_INPUT_ELEMENT_DESC{ "INDICES",     0, DXGI_FORMAT_R32_FLOAT,          0, D3D12_APPEND_ALIGNED_ELEMENT, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },
            D3D12_INPUT_ELEMENT_DESC{ "WEIGHTS",     0, DXGI_FORMAT_R32_FLOAT,          0, D3D12_APPEND_ALIGNED_ELEMENT, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 }
        };
